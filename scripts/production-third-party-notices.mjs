...
export async function generateProductionThirdPartyNotices() {
  ...
  return `${[
    ...
    '',
    'Apache Xerces-C++ 3.3.0 and Emscripten 6.0.5 are shipped as separate runtime',
    'assets. Their complete terms are distributed as LICENSE.xerces.txt,',
    'NOTICE.xerces.txt, and LICENSE.emscripten.txt.',
    '',
